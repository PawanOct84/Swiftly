...
class SwiftJSONModelFile: ModelFile {
    var fileName: String
    ...
    var propertyComponents: [PropertyComponent]?
    ...
    func setInfo(_ fileName: String, _ configuration: ModelGenerationConfiguration) {
    ...
    func addComponentsFor(_ property: PropertyComponent) {
        propertyComponents?.append(property)
    }
    
    
    func  generateAllComponents() {
        self.component = ModelComponent()
        propertyComponents?.forEach { propertyComponent in
            self.generateAndAddComponentsFor(propertyComponent)
        }
    }
